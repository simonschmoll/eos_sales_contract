...
cleos push action eosio.token issue '["buyer", "1000.0000 EOS", "memo"]' -p eosio@active 
cleos push action eosio.token issue '["intermed", "1000.0000 EOS", "memo"]' -p eosio@active